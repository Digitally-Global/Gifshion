...
<body style="font-family: 'Inter', sans-serif; background: #E5E5E5;">
                ...
                <td class="main-content" style="padding: 48px 30px 40px; color: #000000;" bgcolor="#ffffff">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          **PRODUCT** is out of stock. Please check the website for more information.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 24px 0;">
                          <a class="button" href="**URL**" title="Reset Password" style="width: 100%; background: #4C83EE; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Go To Website</a>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px;">
  ...
  html = html.replace("**URL**",f"https://gifshion.com{instance.get_absolute_url()}")
  html = html.replace("**PRODUCT**",instance.name)
  print(instance.get_absolute_url())
  sender_email = "ccegifshion24x7@gmail.com"
  receiver_email = "ccegifshion24x7@gmail.com"
  message = MIMEMultipart("alternative")
  message["Subject"] = f"OUT OF STOCK!"
  message["From"] = sender_email
  message["To"] = receiver_email
  message.attach(MIMEText(html, "html"))
  with smtplib.SMTP(HOST,PORT) as server:
