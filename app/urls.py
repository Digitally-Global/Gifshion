...
#     end cart
 ...
 path('shipping-rates/<str:country>',views.get_shipping_rates,name="shipping-rates"),
...
admin.site.site_header = "Gifshion"
admin.site.site_title = "Gifshion Portal"
admin.site.index_title = "Welcome to Gifshion  Portal"
