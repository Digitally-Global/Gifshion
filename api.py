...
# set the WSDL URL
wsdl_url = "https://netconnect.bluedart.com/Ver1.10/ShippingAPI/WayBill/WayBillGeneration.svc?wsdl"

# set method URL
method_url = "http://webservices.oorsprong.org/websamples.countryinfo/GenerateWayBill"

# set service URL
service_url = "http://webservices.oorsprong.org/websamples.countryinfo/GenerateWayBill.wso"
import http.client
import urllib.parse
